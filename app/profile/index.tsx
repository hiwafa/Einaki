...
import { constants } from '../../constants/Measures';
                ...
                <View style={[styles.ctaStyles, { backgroundColor: bgColor }]}>
                    <MapList fragment data={TheadCTAOptionsList}
                        renderItem={(item, index) => <CTAItems key={index}
                            name={item.name} iconName={item.icon} iconType={item.iconType}
                        />} />
                </View>
...
const styles = StyleSheet.create({
    ...
    communityTextContainer: {
        paddingHorizontal: constants.padding, width: '90%'
    },
    iconContainer: {
        paddingHorizontal: 8,
