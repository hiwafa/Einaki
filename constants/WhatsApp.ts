...
export const TheadSettingsOptionsList = [
  { name: 'Mute Notification', icon: 'bell', iconType: Icons.MaterialCommunityIcons, switch: true },
  { name: 'Custom notification', icon: 'music-note', iconType: Icons.MaterialIcons },
  { name: 'Media visibility', icon: 'insert-photo', iconType: Icons.MaterialIcons, desc: 'Off' },
...
export const TheadSettingsOptionsList2 = [
  ...
  {
    name: 'Disappearing messages', icon: 'progress-clock',
    iconType: Icons.MaterialCommunityIcons, desc: '90 days'
  },
  {
